...
//	a category of JHDocument for toolbar delegate, validation and helper/action methods
@interface JHDocument (JHDocument_Toolbar)
...
//action for bold, italic, underline buttons in toolbar
